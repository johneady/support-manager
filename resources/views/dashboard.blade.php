<x-layouts::app :title="__('Dashboard')">
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl">
        {{-- Welcome Header --}}
        <div class="relative overflow-hidden rounded-2xl bg-linear-to-r from-violet-500 via-pink-500 to-amber-500 p-6 text-white shadow-lg shadow-violet-500/20">
            ...
            <div class="relative">
                ...
                <p class="mt-1 text-white/80">Here's what's happening with your support tickets.</p>
            </div>
        </div>
