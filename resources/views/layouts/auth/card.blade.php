...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-blue-50 antialiased dark:bg-linear-to-b dark:from-blue-950 dark:to-neutral-900">
        <div class="bg-blue-100 flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10 dark:bg-blue-900/30">
            <div class="flex w-full max-w-md flex-col gap-6">
                ...
                <div class="flex flex-col gap-6">
                    <div class="rounded-xl border bg-white dark:bg-stone-950 dark:border-blue-800 text-stone-800 shadow-xs">
