            ...
            <div class="mt-8 rounded-2xl border border-blue-100 bg-white/80 px-6 py-6 backdrop-blur-sm sm:px-8 dark:border-zinc-700 dark:bg-zinc-800/80">
                <div class="prose dark:prose-invert prose-blue prose-headings:font-semibold prose-a:text-blue-600 dark:prose-a:text-blue-400 max-w-none">
                    ...
                    <p>
                        ...
                        and safeguard your personal information when you use our support platform.
                    </p>
                    ...
                    <ul>
                        <li>
                            <strong>Account information</strong> &mdash; your name, email address, and password when you
                            register for an account.
                        </li>
                        <li>
                            <strong>Support ticket content</strong> &mdash; the messages, descriptions, and any
                            attachments you submit through support tickets.
                        </li>
                        <li>
                            <strong>Usage data</strong> &mdash; information about how you interact with our platform,
                    ...
                    <p>
                        All communication with our team is conducted exclusively through support tickets submitted via
                        this platform. We do not offer support through external email, phone, or social media channels.
                        Any correspondence related to your account or inquiries should be submitted as a support ticket.
                    </p>
                    ...
                    <p>
                        ...
                        provide you with our services. Support ticket data is retained to maintain a complete history of
                        interactions for reference purposes. If you wish to request deletion of your data, please submit
                        a support ticket.
                    </p>
                    ...
                    <p>
                        ...
                        information with trusted service providers who assist us in operating our platform, provided
                        they agree to keep your information confidential.
                    </p>

                    <h2>Cookies</h2>
                    <p>
                        Our platform uses cookies that are essential for the operation of the service, such as session
                        cookies for authentication. These cookies are necessary for the platform to function correctly
                    ...
                    <ul>
                        ...
                        <li>
                            Request deletion of your personal data, subject to any legal obligations we may have to
                            retain it.
                        </li>
