...
<div
    ...
    class="markdown-editor overflow-hidden rounded-lg border border-zinc-200 bg-white dark:border-zinc-700 dark:bg-zinc-900"
>
    {{-- Toolbar --}}
    <div class="flex flex-wrap items-center gap-0.5 border-b border-zinc-200 bg-zinc-50 px-2 py-1.5 dark:border-zinc-700 dark:bg-zinc-800">
        ...
        <button
            ...
            :class="isActive('bold') && 'bg-zinc-200 dark:bg-zinc-600'"
            class="rounded p-1.5 text-zinc-600 transition-colors hover:bg-zinc-200 dark:text-zinc-300 dark:hover:bg-zinc-600"
            title="Bold"
        >
        ...
        <button
            ...
            :class="isActive('italic') && 'bg-zinc-200 dark:bg-zinc-600'"
            class="rounded p-1.5 text-zinc-600 transition-colors hover:bg-zinc-200 dark:text-zinc-300 dark:hover:bg-zinc-600"
            title="Italic"
        >
            <svg class="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
        ...
        <button
            ...
            :class="isActive('code') && 'bg-zinc-200 dark:bg-zinc-600'"
            class="rounded p-1.5 text-zinc-600 transition-colors hover:bg-zinc-200 dark:text-zinc-300 dark:hover:bg-zinc-600"
            title="Inline Code"
        >
        ...
        <button
            ...
            :class="isActive('strike') && 'bg-zinc-200 dark:bg-zinc-600'"
            class="rounded p-1.5 text-zinc-600 transition-colors hover:bg-zinc-200 dark:text-zinc-300 dark:hover:bg-zinc-600"
            title="Strikethrough"
        >
            <svg class="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <button
            ...
            :class="isActive('highlight') && 'bg-zinc-200 dark:bg-zinc-600'"
            class="rounded p-1.5 text-zinc-600 transition-colors hover:bg-zinc-200 dark:text-zinc-300 dark:hover:bg-zinc-600"
            title="Highlight"
        >
            <svg class="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <button
            type="button"
            x-on:click="toggleHeading(2)"
            :class="isActive('heading', { level: 2 }) && 'bg-zinc-200 dark:bg-zinc-600'"
            class="rounded px-1.5 py-1 text-xs font-bold text-zinc-600 transition-colors hover:bg-zinc-200 dark:text-zinc-300 dark:hover:bg-zinc-600"
            title="Heading 2"
        >
            H2
        </button>
        <button
            ...
            :class="isActive('heading', { level: 3 }) && 'bg-zinc-200 dark:bg-zinc-600'"
            class="rounded px-1.5 py-1 text-xs font-bold text-zinc-600 transition-colors hover:bg-zinc-200 dark:text-zinc-300 dark:hover:bg-zinc-600"
            title="Heading 3"
        >
            H3
        ...
        <button
            ...
            :class="isActive('heading', { level: 4 }) && 'bg-zinc-200 dark:bg-zinc-600'"
            class="rounded px-1.5 py-1 text-xs font-bold text-zinc-600 transition-colors hover:bg-zinc-200 dark:text-zinc-300 dark:hover:bg-zinc-600"
            title="Heading 4"
        >
            H4
        ...
        <button
            ...
            :class="isActive('bulletList') && 'bg-zinc-200 dark:bg-zinc-600'"
            class="rounded p-1.5 text-zinc-600 transition-colors hover:bg-zinc-200 dark:text-zinc-300 dark:hover:bg-zinc-600"
            title="Bullet List"
        >
            <svg class="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <button
            ...
            :class="isActive('orderedList') && 'bg-zinc-200 dark:bg-zinc-600'"
            class="rounded p-1.5 text-zinc-600 transition-colors hover:bg-zinc-200 dark:text-zinc-300 dark:hover:bg-zinc-600"
            title="Ordered List"
        >
            <svg class="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <button
            ...
            :class="isActive('blockquote') && 'bg-zinc-200 dark:bg-zinc-600'"
            class="rounded p-1.5 text-zinc-600 transition-colors hover:bg-zinc-200 dark:text-zinc-300 dark:hover:bg-zinc-600"
            title="Blockquote"
        >
        ...
        <button
            ...
            :class="isActive('codeBlock') && 'bg-zinc-200 dark:bg-zinc-600'"
            class="rounded p-1.5 text-zinc-600 transition-colors hover:bg-zinc-200 dark:text-zinc-300 dark:hover:bg-zinc-600"
            title="Code Block"
        >
            <svg class="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <button
            type="button"
            x-on:click="setLink()"
            :class="isActive('link') && 'bg-zinc-200 dark:bg-zinc-600'"
            class="rounded p-1.5 text-zinc-600 transition-colors hover:bg-zinc-200 dark:text-zinc-300 dark:hover:bg-zinc-600"
            title="Link"
        >
            <svg class="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
