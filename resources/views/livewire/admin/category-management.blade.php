...
<div class="space-y-6">
    ...
    @else
                ...
                >
                    @foreach ($this->categories as $category)
                        ...
                        >
                            ...
                            <td class="px-4 py-4 text-sm text-zinc-500 dark:text-zinc-400">{{ $category->slug }}</td>
        ...
        <div class="mt-6">{{ $this->categories->links() }}</div>
    @endif
            ...
            <form wire:submit="createCategory" class="space-y-4" x-data>
                <div class="space-y-4 rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-950/30">
                    ...
                    <flux:field>
                        ...
                        <flux:text size="sm" class="text-zinc-500"
                            >Inactive categories won't be shown in ticket creation form.</flux:text>
                    </flux:field>
